...
const achievements = [
	{
		title: '50+ Events',
		description: 'Hosting diverse events, from workshops to hackathons and networking sessions',
		position: 'upper left',
	},
	{
		title: '1000+ Members',
		description: 'Growing community of students passionate about web3, blockchain, and crypto',
		position: 'bottom left',
	},
	{
		title: '20+ Committees',
		description:
			'Dedicated teams working across various domains to create impactful student experiences',
		position: 'upper right',
	},
	{
		title: '20+ Partners',
		description:
			'Collaborations with industry leaders providing opportunities and resources for our members',
...
function AnimatedYellowDot({
	...
	const textContainerClasses = cn(
		'absolute top-1/2 -translate-y-1/2 w-72 transition-opacity duration-300',
		isLeftSide ? 'right-full mr-10 text-right' : 'left-full ml-10 text-left',
		isActive ? 'opacity-100' : 'opacity-0'
	);

	return (
		<div className={cn('absolute z-10 hidden lg:block', positionClasses)}>
			{/* Text container */}
